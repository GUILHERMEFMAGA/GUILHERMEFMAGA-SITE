...
- **r91 — SEM MENSAGEM PERDIDA + INTERAJA À PROVA DE VARIANTES (2 falhas
  ...
  `-r91`. Próxima prova no PC: 'atualizar agora' (p/ r91; 'Baixei a
  versao nova' antes de reiniciar) + 'mande oi para +55 51 9268-6262'
  (agora abre a conversa do número direto) + 'interaja com NOME' (com
  leitor disponível) + qualquer forma de parar.
