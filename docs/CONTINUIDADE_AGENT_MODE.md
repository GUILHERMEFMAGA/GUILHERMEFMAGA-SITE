...
- **r89 — PARA ENTENDE O PORTUGUÊS (pergunta real do dono 14/09)**: "e no
  ...
  OK**. Selo `-r89`. Próxima prova no PC: 'atualizar agora' (p/ r89;
  'Baixei a versao nova' antes de reiniciar) + 'quantos contatos eu tenho'
  + 'modo conversa NOME' (com leitor disponível) + qualquer forma de
  parar.
