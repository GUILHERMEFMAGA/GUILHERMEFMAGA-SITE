...
- **r88 — MODO CONVERSA WHATSAPP (conversa infinita em segundo plano, pedido
  ...
  Próxima prova no PC: 'atualizar agora' (p/ r88; 'Baixei a versao nova'
  antes de reiniciar) + 'quantos contatos eu tenho' + 'modo conversa NOME'
  (com leitor disponível).
