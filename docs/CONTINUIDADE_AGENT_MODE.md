...
- **r90 — O AGENTE ENTENDE 'INTERAJA COM' E 'MANDE MENSAGEM PARA NÚMERO
  ...
  OK**. Selo `-r90`. Próxima prova no PC: 'atualizar agora' (p/ r90;
  'Baixei a versao nova' antes de reiniciar) + 'quantos contatos eu
  tenho' + 'interaja com NOME' (com leitor disponível) + 'mande oi para
  +55 ...' + qualquer forma de parar.
