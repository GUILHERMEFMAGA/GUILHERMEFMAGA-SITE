...
Atualizado em 14/09/2026 (cobre **r21 → r84**; releases posteriores a esta data: veja `git log` e os comentários do PR #4). Este documento descreve a **r21** (confiabilidade das respostas
...
- **r83 — DIAGNÓSTICO DE MICROFONE (do bug real do STT no PC do dono, 14/09)**:
  ...
  `-r83`. Proxima prova no PC: 'atualizar agora' (p/ r84) +
  'diagnostico de microfone' + print; depois 'falar' de novo.
