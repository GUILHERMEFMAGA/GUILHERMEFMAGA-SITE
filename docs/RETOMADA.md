...
```
Esperado: `Ran 898 tests ... OK (skipped=3)` e o selo `-r81` em agente.py. Deu certo? Você está EXATAMENTE onde paramos.
...
- `docs/CONTINUIDADE_AGENT_MODE.md` — diário completo r1→r81 + regras + lições + posicionamento honesto.
- `esqueletos_ideias/` — listas (20/30/50+40/80/100/impossível = SÓ PROPOSTA), análise de lacunas, auditoria.
- `tests/` — 89 arquivos, 898 testes (loader em test_roteamento_conversa.py).
