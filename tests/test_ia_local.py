...
class IALocal(unittest.TestCase):
    def ambiente(self, **extras):
        return carregar('_anexar_referencias_revisadas', '_referencias_revisadas_local', '_remover_itens_repetidos_local', '_correcoes_relevantes_local', '_perfil_resposta_local', '_quantidade_lista_local', '_contar_itens_lista_local',
